...
|------|------|------|------|------|:-----|
| 最高温度 | 2.86 | 13.60 | 3.69 | 0.84 | 优秀 |
| 最低温度 | 1.91 | 5.73 | 2.39 | 0.93 | 优秀 |
| 平均温度 | 1.98 | 6.51 | 2.55 | 0.92 | 优秀 |
| 湿度 | 9.18 | 146.74 | 12.11 | 0.19 | 较弱 |
| 风速 | 4.50 | 37.26 | 6.10 | -0.03 | 无效 |
| 降水量 | 4.67 | 72.55 | 8.52 | -0.07 | 无效 |

> 杂交架构：LSTM encoder-decoder，温度自回归解码 + 湿度/风速/降水直接多步输出。训练数据：南阳市 2011-2026 年逐日观测（15 年），测试集固定为 2023 年。14 个地表特征，seq_len=7。
...
- 14 个特征：温度、湿度、降水、风速、气压、短波辐射、露点等
